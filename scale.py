...
# Start jobs back up with new number of workers.
...
def update_shards(stream_name, target_shard_count):
    res = kds.update_shard_count(
        StreamName=stream_name, TargetShardCount=target_shard_count, ScalingType="UNIFORM_SCALING"
    )
